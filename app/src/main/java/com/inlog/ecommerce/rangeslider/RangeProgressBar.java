...
import com.inlog.ecommerce.BuildConfig;
...
public class RangeProgressBar extends View {
    protected static LoggerFactory.Logger logger =
        LoggerFactory.getLogger("RangeProgressBar", BuildConfig.DEBUG ? LoggerFactory.LoggerType.Console : LoggerFactory.LoggerType.Null);
