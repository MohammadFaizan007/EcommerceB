...
public final class LayoutPopShaopratingDailogBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RatingBar ratingfour;
  ...
  private LayoutPopShaopratingDailogBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RelativeLayout mainlayout, @NonNull RatingBar ratingfour,
      @NonNull RatingBar ratingone, @NonNull RatingBar ratingthree, @NonNull RatingBar ratingtwo,
  ...
  @NonNull
  public static LayoutPopShaopratingDailogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutPopShaopratingDailogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_pop_shaoprating_dailog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutPopShaopratingDailogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ratingfour;
      RatingBar ratingfour = rootView.findViewById(id);
      if (ratingfour == null) {
        break missingId;
      }
      ...
      return new LayoutPopShaopratingDailogBinding((RelativeLayout) rootView, cancelObj,
          cirsubmitButton, itemtitle, ltview, mainlayout, ratingfour, ratingone, ratingthree,
          ratingtwo, reviewTextview);
    }
