...
public final class FragmentTwoBinding implements ViewBinding {
  ...
  private FragmentTwoBinding(@NonNull RelativeLayout rootView,
      @NonNull RecyclerView recyclerviewitem) {
  ...
  public static FragmentTwoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView recyclerviewitem = rootView.findViewById(id);
      if (recyclerviewitem == null) {
        break missingId;
      }

      return new FragmentTwoBinding((RelativeLayout) rootView, recyclerviewitem);
    }
