...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView,
      @NonNull BottomNavigationBar bottomBar, @NonNull DrawerLayout drawerLayout,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.bottom_bar;
      BottomNavigationBar bottomBar = rootView.findViewById(id);
      if (bottomBar == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, bottomBar, drawerLayout, navView);
    }
