...
public abstract class BaseSliderView {
    ...
    public String getmDescriptionfont() {
        return mDescriptionfont;
    }

    public void setmDescriptionfont(String mDescriptionfont) {
        this.mDescriptionfont = mDescriptionfont;
    }

    private String textfont;
    private String mDescriptionfont;
    ...
    public BaseSliderView text(String text){
        textlbl = text;
        return this;
    }
    ...
    public BaseSliderView desfont(String desfont){
        mDescriptionfont = desfont;
        return this;
    }
    /**
